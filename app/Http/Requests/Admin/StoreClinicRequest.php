...
class StoreClinicRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phone' => ['required', 'string', 'max:255', Rule::unique('salons', 'phone')->whereNull('deleted_at')],
            'website' => ['required', 'url', 'max:255', Rule::unique('salons', 'website')->whereNull('deleted_at')],
            ...
            'image_files' => ['nullable', 'array', 'max:4', 'required_without:image_url'],
            ...
            'image_url' => ['nullable', 'url', 'max:500', 'required_without:image_files'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'image_files.required_without' => 'Vui lòng tải ảnh lên hoặc nhập URL ảnh.',
            ...
            'image_url.required_without' => 'Vui lòng tải ảnh lên hoặc nhập URL ảnh.',
