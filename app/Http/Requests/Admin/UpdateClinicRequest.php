...
class UpdateClinicRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'phone' => ['nullable', 'string', 'max:255', Rule::unique('salons', 'phone')->ignore($clinic?->id)->whereNull('deleted_at')],
            'website' => ['nullable', 'url', 'max:255', Rule::unique('salons', 'website')->ignore($clinic?->id)->whereNull('deleted_at')],
